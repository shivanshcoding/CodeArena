  ...
  return (
    <div className="p-6 relative">
      ...
      <div>
        ...
        {activeTab === 'Editorial' && (
          <div className="whitespace-pre-wrap text-foreground">{question.editorial || 'No editorial available.'}</div>
        )}

        {activeTab === 'Solutions' && (
          <div className="whitespace-pre-wrap text-foreground">{question.solutions || 'No solutions uploaded.'}</div>
        )}
